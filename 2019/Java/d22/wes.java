...
public class wes {
  ...
  public static void main(String[] args) throws Exception {
    wes W = new wes();
    System.out.println("Part 1: "+W.solve1("d22/wes-input.txt", 2019, 10007));
    System.out.println("Part 2: "+W.solve2("d22/wes-input.txt", BigInteger.valueOf(119315717514047L), BigInteger.valueOf(101741582076661L), 2020).toString());
  }
}

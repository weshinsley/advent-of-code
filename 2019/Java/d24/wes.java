...
public class wes {
 ...
 long readInput(String f) throws Exception {
  ...
  void test() throws Exception {
    long x = readInput("d24/example1.txt");
    x = update1(x);
    if (x!=toLong("#..#.####.###.###.##.##..")) System.out.println("Test 1 - failed at update 1");
    x = update1(x);
    if (x!=toLong("#####....#....#...#.#.###")) System.out.println("Test 1 - failed at update 2");
    x = update1(x);
    if (x!=toLong("#....####....###.##..##.#")) System.out.println("Test 1 - failed at update 3");
    x = update1(x);
    if (x!=toLong("####.....###..#.....##...")) System.out.println("Test 1 - failed at update 4");
    if (solve1(readInput("d24/example1.txt")) != 2129920) System.out.println("Test 1 - final answer wrong");
    if (solve2(readInput("d24/example2.txt"),10) != 99) System.out.println("Test 2 was not 99");
  }

  public static void main(String[] args) throws Exception {
    wes W = new wes();
    W.test();
    System.out.println("Part 1 : "+W.solve1(W.readInput("d24/wes-input.txt")));
    System.out.println("Part 2 : "+W.solve2(W.readInput("d24/wes-input.txt"),200));
  }
}

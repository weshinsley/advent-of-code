...
public class wes {
  ...
  void test() throws Exception {
    readInput("d06/test-input1.txt");
    if (solve1() != 42) System.out.println("Test 1 was not 42");
    readInput("d06/test-input2.txt");
    if (solve2() != 4) System.out.println("Test 2 was not 4");
  }

  public static void main(String[] args) throws Exception {
    wes W = new wes();
    W.test();
    W.readInput("d06/wes-input.txt");

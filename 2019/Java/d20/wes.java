...
public class wes {
  ...
  public void test() throws Exception {
    if (solve(readInput("d20/example1.txt"), true) != 23) System.out.println("Test 1 failed");
    if (solve(readInput("d20/example2.txt"), true) != 58) System.out.println("Test 2 failed");
    if (solve(readInput("d20/example1.txt"), false) != 26) System.out.println("Test 3 failed");
    if (solve(readInput("d20/example3.txt"), false) != 396) System.out.println("Test 4 failed");
  }

  public static void main(String[] args) throws Exception {
    wes W = new wes();
    W.test();
    System.out.println("Part 1: "+W.solve(W.readInput("d20/wes-input.txt"), true));
    System.out.println("Part 2: "+W.solve(W.readInput("d20/wes-input.txt"), false));

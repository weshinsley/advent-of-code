...
public class wes {
  ...
  void test() throws Exception {
    if (solve1(readInput("d12/example1_10_179.txt"), 10) != 179) System.out.println("P1: Example 1, 10 iters, was not 179");
    if (solve1(readInput("d12/example2_100_1940.txt"), 100) != 1940) System.out.println("P1: Example 2, 100 iters, was not 1940");
    if (solve2("d12/example1_10_179.txt") != 2772L) System.out.println("P2: Example 3 was not 2772");
    if (solve2("d12/example3_4686774924.txt") != 4686774924L) System.out.println("P2: Example 3 was not 4686774924");
  }
   
  public static void main(String[] args) throws Exception {
    wes W = new wes();
    W.test();
    System.out.println("Part 1: "+W.solve1(W.readInput("d12/wes-input.txt"), 1000)); 
    System.out.println("Part 2: "+W.solve2("d12/wes-input.txt"));

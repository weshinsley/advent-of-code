...
public class wes {
  ...
  void expect(int res, int exp, String test) {
    if (res!=exp) System.out.println("Test "+test+", gave "+res+" instead of "+exp);
  }
  void test() throws Exception {
    expect(solve(readInput("d18/example_1_8.txt"),false), 8, "1");
    expect(solve(readInput("d18/example_2_86.txt"),false), 86, "2");
    expect(solve(readInput("d18/example_3_132.txt"),false), 132, "3");
    //expect(solve(readInput("d18/example_4_136.txt"),false, false), 136, "4");
    expect(solve(readInput("d18/example_5_81.txt"),false), 81, "5");
    expect(solve(readInput("d18/example_6_8.txt"), true), 8, "6");
    expect(solve(readInput("d18/example_7_24.txt"), false), 24, "7");
    expect(solve(readInput("d18/example_8_32.txt"), false), 32, "8");
  }
  ...
  public static void main(String[] args) throws Exception {
    wes W = new wes();
    W.test();
    System.out.println("Part 1: "+W.solve(W.readInput("d18/wes-input.txt"), false));
    System.out.println("Part 2: "+W.solve(W.readInput("d18/wes-input.txt"), true));
  }
}
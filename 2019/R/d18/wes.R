...
test <- function() {
  stopifnot(8 == part1(parse_input("example_1_8.txt"), FALSE, 8))
  stopifnot(86 == part1(parse_input("example_2_86.txt"), FALSE, 86))
  stopifnot(132 == part1(parse_input("example_3_132.txt"), FALSE, 132))
  stopifnot(136 == part1(parse_input("example_4_136.txt"), FALSE, 136))
  stopifnot(81 == part1(parse_input("example_5_81.txt"), FALSE, 81))
  stopifnot(8 == part2(parse_input("example_6_8.txt"), 8))
  stopifnot(24 == part2(parse_input("example_7_24.txt"), 24))
  stopifnot(32 == part2(parse_input("example_8_32.txt"), 32))
}

d <- parse_input("wes-input.txt")
res <- part1(d)
res
part2(d, res)

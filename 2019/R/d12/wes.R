...
test <- function() {
  expect_equal(solve(read_input("d12/example1_10_179.txt"), 10), 179)
  expect_equal(solve(read_input("d12/example2_100_1940.txt"), 100), 1940)
  expect_equal(solve(read_input("d12/example1_10_179.txt"), Inf, TRUE), 2772)
  expect_equal(solve(read_input("d12/example3_4686774924.txt"), Inf, TRUE), 4686774924)
}

test()
moons <- read_input("d12/wes-input.txt")
message(sprintf("Part 1: %d", solve(moons, 1000)))
message(sprintf("Part 2: %f", solve(moons, Inf, TRUE)))

...
test <- function() {
  expect_equal(solve1(read_input("d06/test-input1.txt")), 42)
  expect_equal(solve2(read_input("d06/test-input2.txt")), 4)
}

test()
wes <- read_input("d06/wes-input.txt")
message(sprintf("Part 1: %d", solve1(wes)))
message(sprintf("Part 2: %d", solve2(wes)))

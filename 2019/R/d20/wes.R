...
test <- function() {
  expect_equal(solve("d20/example1.txt"), 23)
  expect_equal(solve("d20/example2.txt"), 58)
  expect_equal(solve("d20/example1.txt", FALSE), 26)
  expect_equal(solve("d20/example3.txt", FALSE), 396)
}

test()
message("Part 1: ", solve("d20/wes-input.txt"))
message("Part 2: ", solve("d20/wes-input.txt", FALSE))

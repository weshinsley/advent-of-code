...
test <- function() {
  expect_equal(solve1(readLines("d24/example1.txt")), 2129920)
  expect_equal(solve2(readLines("d24/example2.txt"),10), 99)
}

test()
message("Part 1 : ",solve1(readLines("d24/wes-input.txt")))
message("Part 2 : ",solve2(readLines("d24/wes-input.txt"),200))

...
public class wes {
  ...
  void test() throws Exception {
    ArrayList<String> input = Utils.readLines("../R/18/example.txt");
    Utils.test((int)part1(input), 4);
    input = Utils.readLines("../R/18/example2.txt");
    Utils.test((int)part2(input), 3);
  }

  public static void main(String[] args) throws Exception {
    wes w = new wes();
    w.test();
    ArrayList<String> input = Utils.readLines("../R/18/input.txt");

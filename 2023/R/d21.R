...
test <- function() {
  d <- parse_input("../inputs/d21-test.txt")
  stopifnot(part1(d, 6) == 16)
  # stopifnot(slow_part1(d, 6) == 16)
  # stopifnot(slow_part1(d, 50) == 1594)
  # stopifnot(slow_part2(d, 50) == 1594)
  # stopifnot(slow_part2(d, 100) == 6536)
  # stopifnot(slow_part2(d, 500) == 167004)
  # stopifnot(slow_part2(d, 1000) == 668697)
  # stopifnot(slow_part2(d, 5000) == 16733044)
}

test()
d <- parse_input("../inputs/d21-input.txt")
part1(d)
part2(d)

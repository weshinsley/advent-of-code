...
test <- function() {
  d <- parse_input("../inputs/d20-test1.txt")
  r <- button(d)
  stopifnot(all(0 == unlist(lapply(r$d, `[[`, "state"))))
  stopifnot(r$lo == 8)
  stopifnot(r$hi == 4)
  stopifnot(r$total == 32)
  stopifnot(part1(d) == 32000000)

  d <- parse_input("../inputs/d20-test2.txt")
  stopifnot(part1(d) == 11687500)
}

test()
d <- parse_input("../inputs/d20-input.txt")
part1(d)
part2(d)

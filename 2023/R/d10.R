...
test <- function() {
  stopifnot(part1(parse_input("../inputs/d10-test1.txt")) == 4)
  stopifnot(part1(parse_input("../inputs/d10-test2.txt")) == 4)
  stopifnot(part1(parse_input("../inputs/d10-test3.txt")) == 8)
  stopifnot(part1(parse_input("../inputs/d10-test4.txt")) == 8)
  stopifnot(part2(parse_input("../inputs/d10-test5.txt")) == 4)
  stopifnot(part2(parse_input("../inputs/d10-test5b.txt")) == 4)
  stopifnot(part2(parse_input("../inputs/d10-test6.txt")) == 8)
  stopifnot(part2(parse_input("../inputs/d10-test7.txt")) == 10)
}

test()
d <- parse_input("../inputs/d10-input.txt")
part1(d)
part2(d)

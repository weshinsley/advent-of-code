...
d <- read.csv("../inputs/d08-test1.txt", sep = " ", header = FALSE)
stopifnot(identical(c(part1(d), part2(d)), c(0, 5353)))

d <- read.csv("../inputs/d08-test2.txt", sep = " ", header = FALSE)
stopifnot(identical(c(part1(d), part2(d)), c(26, 61229)))

d <- read.csv("../inputs/d08-input.txt", sep = " ", header = FALSE)
part1(d)
part2(d)

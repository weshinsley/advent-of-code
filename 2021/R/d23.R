...
test <- function() {
  stopifnot(part1(parse_input("../inputs/d23-test.txt")) == 12152)
  stopifnot(part2(parse_intpu("../inputs/d23-test.txt", TRUE)) == 44169)
}

part1(parse_input("../inputs/d23-input.txt"))
part2(parse_input("../inputs/d23-input.txt", TRUE))

d <- as.integer(strsplit(gsub("\\.\\.", ",", gsub(", y=", ",", 
       gsub("target area: x=", "", readLines("../inputs/d17-input.txt")))),",")[[1]])
...
tests <- function() {
  stopifnot(shot(7, 2, 20, 30, -10, -5) > 0)
  stopifnot(shot(6,3, 20, 30, -10, -5) > 0)
  stopifnot(shot(6, 9, 20, 30,-10,-5) > 0)
  stopifnot(shot(6, 9, 20, 30,-10,-5) > 0)
  stopifnot(shot(17, -4, 20, 30,-10,-5) == -Inf)
}

...
d <- lapply(strsplit(readLines("../inputs/d09-test.txt"), ""), as.integer)
stopifnot(identical(solve(d), c(15, 1134)))

d <- lapply(strsplit(readLines("../inputs/d09-input.txt"), ""), as.integer)
res <- solve(d)
part1(res)
part2(res)

...
d <- read_input("../inputs/d14-test.txt")
stopifnot(solve_slow(d$target, d$rules, 10) == 1588)
stopifnot(solve_fast(d$target, d$rules, 10) == 1588)
stopifnot(solve_fast(d$target, d$rules, 40) == 2188189693529)
...
d <- read_input("../inputs/d14-input.txt")
part1(d$target, d$rules)
part2(d$target, d$rules)

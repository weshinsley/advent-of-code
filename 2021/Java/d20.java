...
public class d20 {
  ...
  public static void main(String[] args) throws Exception {
    d20 W = new d20();
    W.read_input("../inputs/d20-test.txt");
    if (35 != W.solve(2)) System.out.println("Test 1 (35) failed!");
    W.read_input("../inputs/d20-test.txt");
    if (3351 != W.solve(50)) System.out.println("Test 2 (3351) failed!");
    W.read_input("../inputs/d20-input.txt");

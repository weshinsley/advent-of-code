...
stopifnot(solve(load("../Java/d08/test_5_8.txt"))[[1]] == 5)
stopifnot(solve2(load("../Java/d08/test_5_8.txt"))[[1]] == 8)

cat(red("\nAdvent of Code 2020 - Day 08\n"))
cat(blue("----------------------------\n\n"))
cat("Part 1:", green(solve(load("../Java/d08/wes-input.txt"))[[1]]), "\n")
cat("Part 2:", green(solve2(load("../Java/d08/wes-input.txt"))[[1]]), "\n")

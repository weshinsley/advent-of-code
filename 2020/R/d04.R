...
stopifnot(solve(load("../Java/d04/test_part1_2.txt"), 1) == 2)
...
stopifnot(solve(load("../Java/d04/test_part2_0.txt"), 2) == 0)
stopifnot(solve(load("../Java/d04/test_part2_4.txt"), 2) == 4)

wes <- load("../Java/d04/wes-input.txt")

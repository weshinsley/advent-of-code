...
stopifnot(solve(readLines("../Java/d14/test1_165.txt"), FALSE) == 165)
stopifnot(solve(readLines("../Java/d14/test2_208.txt"), TRUE) == 208)

wes <- readLines("../Java/d14/wes-input.txt")

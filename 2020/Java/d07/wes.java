...
public class wes {
  ...
  void run() throws Exception {
    parse_manky_input("d07/test_4_32.txt");
    stop_if_not(solve(1), 4, "Test 1, part 1");
    stop_if_not(solve(2), 32, "Test 1, part 2");
    parse_manky_input("d07/test_x_126.txt");
    stop_if_not(solve(2), 126, "Test 2, part 2");
    System.out.println("Advent of Code 2020 - Day 07\n----------------------------");
    parse_manky_input("d07/wes-input.txt");

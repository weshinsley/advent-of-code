...
public class wes {
  ...
  String solve2() {
   ...
   void run() throws Exception {
     ...
     read_input("d21/test.txt");
     if (solve1() != 5) System.out.println("Test 1 failed");
     if (!solve2().equals("mxmxvkd,sqjhc,fvjkl")) System.out.println("Test 2 failed");
     read_input("d21/wes-input.txt");

...
public class wes {
  ...
  void run() throws Exception {
    stop_if_not(solve("d17/test_112_848.txt", false), 112, "Test 1");
    stop_if_not(solve("d17/test_112_848.txt", true), 848, "Test 2");
    System.out.println("Advent of Code 2020 - Day 17\n----------------------------");
    System.out.println("Part 1: " + solve("d17/wes-input.txt", false));
    System.out.println("Part 2: " + solve("d17/wes-input.txt", true));
  }

...
public class wes {
  ...
  void run() throws Exception {
    stop_if_not(solve(read_input("d11/test_37_26.txt"), 1), 37, "Test 1");
    stop_if_not(solve(read_input("d11/test_37_26.txt"), 2), 26, "Test 2");
    System.out.println("Advent of Code 2020 - Day 11\n----------------------------");
    System.out.println("Part 1: " + solve(read_input("d11/wes-input.txt"), 1));
    System.out.println("Part 2: " + solve(read_input("d11/wes-input.txt"), 2));
  }

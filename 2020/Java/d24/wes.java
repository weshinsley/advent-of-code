...
public class wes {
  ...
  void run() throws Exception {
    ...
    int[] res = solve(Files.readAllLines(new File("d24/test_10_2208.txt").toPath()));
    if (res[0] != 10) System.out.println("Test 1 failed - expected 10, got "+res[0]);
    if (res[1] != 2208) System.out.println("Test 2 failed - expected 2208, got "+res[1]);

    res = solve(Files.readAllLines(new File("d24/wes-input.txt").toPath()));

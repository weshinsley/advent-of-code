...
public class wes {
  ...
  void run() throws Exception {
    List<String> w = Files.readAllLines(new File("d12/test_25_286.txt").toPath());
    
    stop_if_not(solve1(w), 25, "Test 1");
    stop_if_not(solve2(w), 286, "Test 2");
    
    w = Files.readAllLines(new File("d12/wes-input.txt").toPath());

...
public class wes {
  ...
  Object toObject(String s) {
    if (s.contains("\"")) return new Character(s.charAt(1));
  ...
  void run() throws Exception {
    ...
    stop_if_not(solve("d19/test_p1_2.txt", false), 2, "T1 P1");
    stop_if_not(solve("d19/test_3_12.txt", false), 3, "T1 P1");
    stop_if_not(solve("d19/test_3_12.txt", true), 12, "T1 P2");
    System.out.println("Part 1: "+solve("d19/wes-input.txt", false));
    System.out.println("Part 2: "+solve("d19/wes-input.txt", true));

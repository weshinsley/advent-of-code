...
public class wes {
  ...
  void stop_if_not(long exp, long res, String s) {
    if (exp != res) {
      System.out.println("Error in "+s+", Expected "+exp+" got "+res);
      System.exit(-1);
    }
  }
     
  void run() throws Exception {
    stop_if_not(solve("d22/test_306_291.txt", false), 306, "T1");
    stop_if_not(solve("d22/test_306_291.txt", true), 291, "T2");
    System.out.println("Advent of Code 2020 - Day 22\n----------------------------");
    System.out.println("Part 1: "+solve("d22/wes-input.txt", false));
    System.out.println("Part 2: "+solve("d22/wes-input.txt", true));
  }
